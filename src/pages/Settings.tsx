  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex-1 overflow-auto p-8">
        <h1 className="text-3xl font-bold mb-8">Personalize Your Experience</h1>
        ...
        <div className="grid gap-8">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700">
            ...
            <div className="space-y-4">
              ...
              <ToggleGroup type="single" value={primaryColor} onValueChange={(value) => value && setPrimaryColor(value)}>
                <ToggleGroupItem value="default" className="bg-primary text-white hover:bg-primary/90">
                  Default
                </ToggleGroupItem>
                <ToggleGroupItem value="purple" className="bg-purple-500 text-white hover:bg-purple-600">
                  Purple
                </ToggleGroupItem>
                <ToggleGroupItem value="green" className="bg-green-500 text-white hover:bg-green-600">
                  Green
                </ToggleGroupItem>
                <ToggleGroupItem value="blue" className="bg-blue-500 text-white hover:bg-blue-600">
                  Blue
                </ToggleGroupItem>
              </ToggleGroup>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-100 dark:border-gray-700">
            ...
            <div className="space-y-4">
              ...
              <ToggleGroup type="single" value={fontPreference} onValueChange={(value) => value && setFontPreference(value)}>
          ...
          {/* Save Button */}
          <Button onClick={saveSettings} className="w-full max-w-xs">
            Save Preferences
          </Button>
        </div>
      </div>
